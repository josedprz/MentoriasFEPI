<?php
    ...
    $sql = "SELECT coma.nombre, coma.telefono, hor.mentor, GROUP_CONCAT(hor.hora ORDER BY hor.hora) AS horas
                FROM mentor_hora hor LEFT JOIN (SELECT me.nombre, me.telefono, me.correo, ma.materia
                                                FROM mentores me
                                                LEFT JOIN mentor_materia ma ON me.correo = ma.mentor
                                                WHERE ma.materia = '$materia') coma ON hor.mentor = coma.correo
                WHERE hor.$hora
            GROUP BY hor.mentor;";
                    ...
                    <div class="offcanvas-body d-flex flex-column flex-sm-row">
                        <ul class="navbar-nav justify-content-center align-items-center fs-5 flex-grow-1 pe-3">
                            <li class="nav-item mx-2">
                                <a class="nav-link rounded-5 px-2" style="background-color: #ffde59;" aria-current="page" href="calendario.html">Mis Mentorías</a>
                            </li>
                            <li class="nav-item mx-2">
                                ...
                                <div class="row col-9 justify-content-between mb-3">
                                    ...
                                    <div class="col-3 celda rounded-2">
                                        ...
                                        <?php
                                            ...
                                            echo "<input type='hidden' name='mentor' value='" . $row["nombre"] . "'>";
                                            echo "<select class='col-3 celda rounded-2' name='horas' style='font-size: 1.25rem;'>";
