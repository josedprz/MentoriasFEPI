    ...
    <body class="vh-100">
        ...
        <div class="container">
            <div class="row px-4 py-5 justify-content-center" id="contenido">
                <span class="row col-lg-6 col-sm-12 justify-content-center">
                    <h1 class="col-8 mb-5" style="text-align: center; margin-top: 10%;">Horas Completadas y Validadas</h1>
                    <div class="col-8 horas align-self-end rounded-2 border border-2 border-secondary">24 Horas</div>
                </span>
